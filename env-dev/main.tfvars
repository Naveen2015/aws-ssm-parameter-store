parameters=[
  ...
  Environment=CART_HOST=cart-dev.kruthikadevops.online
  Environment=CART_PORT=8080
  Environment=USER_HOST=user-dev.kruthikadevops.online
  Environment=USER_PORT=8080
  Environment=AMQP_HOST=rabbitmq-dev.kruthikadevops.online
